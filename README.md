...
- `KEYCLOAK_AUTH_USERINFO_URL` (optional override; defaults to `<issuer>/protocol/openid-connect/userinfo`; accepts a comma-separated fallback list that is tried in order)
